...
def get_clone(obj):
    if obj.__class__.__name__.lower() in champions or obj.__class__.__name__.lower() == "goblinsteinmonster":
        return None
...
def champion_factory(side, position, name, level):
    ...
    elif name == "goblinstein":
        return champion_cards.Goblinstein(side, position, level)
    else:
